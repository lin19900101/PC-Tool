...
/* Encodes input (UINT4) into output (unsigned char). Assumes len is
     a multiple of 4.
 */
static void Encode (unsigned char *output,UINT4 *input,unsigned long len)
{
  unsigned long i, j;
...
/* Decodes input (unsigned char) into output (UINT4). Assumes len is
     a multiple of 4.
 */
static void Decode (UINT4 *output,unsigned char *input,unsigned long len)
{
  unsigned long i, j;
  for (i = 0, j = 0; j < len; i++, j += 4)
 ...
 */
static void MD5_memcpy (POINTER output,POINTER input,unsigned long len)
{
  unsigned long i;
 ...
 */
static void MD5_memset (POINTER output,int value,unsigned long len)
{
  unsigned long i;
