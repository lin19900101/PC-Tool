...
#define DIGIT_MSB( x ) ( unsigned long )( ( ( x ) >> ( NN_DIGIT_BITS - 1 ) ) & 1 )
#define DIGIT_2MSB( x ) ( unsigned long )( ( ( x ) >> ( NN_DIGIT_BITS - 2 ) ) & 3 )
/* CONVERSIONS
...
void NN_Decode PROTO_LIST
  ( ( NN_DIGIT *, unsigned long, unsigned char *, unsigned long ) );
void NN_Encode PROTO_LIST
  ( ( unsigned char *, unsigned long, NN_DIGIT *, unsigned long ) );
void NN_Assign PROTO_LIST ( ( NN_DIGIT *, NN_DIGIT *, unsigned long ) );
void NN_AssignZero PROTO_LIST ( ( NN_DIGIT *, unsigned long ) );
void NN_Assign2Exp PROTO_LIST ( ( NN_DIGIT *, unsigned long, unsigned long ) );
NN_DIGIT NN_Add PROTO_LIST
  ( ( NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, unsigned long ) );
NN_DIGIT NN_Sub PROTO_LIST
  ( ( NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, unsigned long ) );
void NN_Mult PROTO_LIST ( ( NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, unsigned long ) );
void NN_Div PROTO_LIST
  ( ( NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, unsigned long, NN_DIGIT *,
    unsigned long ) );
NN_DIGIT NN_LShift PROTO_LIST 
  ( ( NN_DIGIT *, NN_DIGIT *, unsigned long, unsigned long ) );
NN_DIGIT NN_RShift PROTO_LIST
  ( ( NN_DIGIT *, NN_DIGIT *, unsigned long, unsigned long ) );
void NN_Mod PROTO_LIST
  ( ( NN_DIGIT *, NN_DIGIT *, unsigned long, NN_DIGIT *, unsigned long ) );
...
void NN_ModInv PROTO_LIST
  ( ( NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, unsigned long ) );
void NN_Gcd PROTO_LIST ( ( NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, unsigned long ) );
int NN_Cmp PROTO_LIST ( ( NN_DIGIT *, NN_DIGIT *, unsigned long ) );
int NN_Zero PROTO_LIST ( ( NN_DIGIT *, unsigned long ) );
unsigned long NN_Bits PROTO_LIST ( ( NN_DIGIT *, unsigned long ) );
unsigned long NN_Digits PROTO_LIST ( ( NN_DIGIT *, unsigned long ) );
